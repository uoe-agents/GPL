...
print([len(a) for a in raw_data_5], [len(a) for a in raw_data_6], [len(a) for a in raw_data_7])
...
min_lens = min([min_len1, min_len2, min_len3, min_len4, min_len5, min_len6, min_len7, min_len8])
raw_data_1 = [a[:min_lens] for a in raw_data_1]
raw_data_2 = [a[:min_lens] for a in raw_data_2]
raw_data_3 = [a[:min_lens] for a in raw_data_3]
raw_data_4 = [a[:min_lens] for a in raw_data_4]
raw_data_5 = [a[:min_lens] for a in raw_data_5]
raw_data_6 = [a[:min_lens] for a in raw_data_6]
raw_data_7 = [a[:min_lens] for a in raw_data_7]
raw_data_8 = [a[:min_lens] for a in raw_data_8]
...
plt.title("Average Training Return in LBF")
...
plt.savefig("lbforaging-train.pdf", bbox_inches='tight')
