...
def get_args():
    ...
    parser.add_argument('--num_players_train', type=int, default=3, help="num players")
    parser.add_argument('--num_players_test', type=int, default=5, help="num players")
    ...
    # logging
    parser.add_argument('--save-dir', default='learning_parameters', help='directory to save models (default: tmp)')
