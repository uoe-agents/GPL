...
class MRFAgent(object):
    ...
    def update(self):
        ...
        loss_pred = pi_loss + theta_cross_entropy + theta_kl_loss
        ...
        self.writer.add_scalar('loss/pi_cross_entropy', pi_loss, self.num_updates)
        self.writer.add_scalar('loss/theta_cross_entropy', theta_cross_entropy, self.num_updates)
        self.writer.add_scalar('loss/theta_kl_loss', theta_kl_loss, self.num_updates)
