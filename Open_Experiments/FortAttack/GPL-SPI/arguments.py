...
def get_args():
    ...
    parser.add_argument('--reward-type', default="normal", type=str, help='reward scheme used for training')
    ...
    # Training arguments for GPL-SPI
    ...
    parser.add_argument('--save_dir', type=str, default='parameters', help="Folder name for saving model parameters.")
    ...
    parser.add_argument('--constant_temp', type=bool, default=False, help="Constant temperature is used for Boltzmann distribution if set to True.")
    parser.add_argument('--init_temp', type=float, default=1.0, help="Initial temperature.")
