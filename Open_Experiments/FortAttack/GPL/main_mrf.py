...
if __name__ == '__main__':
    ...
    writer.add_scalar('Shooting/test_accuracy', shoot_accuracy, 0)
    writer.add_scalar('Shooting/test_hits', num_hits, 0)
    writer.add_scalar('Shooting/test_attempts', num_shoots, 0)
    ...
    for ep_num in range(num_episode):
        ...
        if (ep_num + 1) % args['saving_frequency'] == 0:
            ...
            writer.add_scalar('Shooting/train_accuracy', shoot_accuracy,
                              (ep_num + 1) // args['saving_frequency'])
            ...
            writer.add_scalar('Rewards/eval', sum(avgs) / len(avgs),
                              (ep_num + 1) // args['saving_frequency'])
            writer.add_scalar('Shooting/test_accuracy', shoot_accuracy,
                              (ep_num + 1) // args['saving_frequency'])
            writer.add_scalar('Shooting/test_hits', num_hits, (ep_num + 1) // args['saving_frequency'])
            writer.add_scalar('Shooting/test_attempts', num_shoots, (ep_num + 1) // args['saving_frequency'])