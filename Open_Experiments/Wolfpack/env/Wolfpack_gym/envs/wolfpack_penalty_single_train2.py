...
class WolfpackPenaltySingleTrain2(gym.Env):
    ...
    def sample_teammates(self, num_sampled):
        poss_teammates = [(GreedyWaitingAgent, TeammateAwareWaitingAgent), (RandomAgent, TeammateAwarePredator), (RandomAgent, TeammateAwareWaitingAgent), (RandomAgent, GreedyProbabilisticWaitingAgent), (GreedyPredatorAgent, GreedyProbabilisticWaitingAgent), (TeammateAwarePredator, TeammateAwareWaitingAgent), (GreedyProbabilisticAgent, DistilledCoopAStarAgent), (TeammateAwarePredator, GreedyWaitingAgent), (GreedyProbabilisticAgent, TeammateAwarePredator), (GreedyPredatorAgent, TeammateAwarePredator), (GreedyPredatorAgent, GreedyWaitingAgent), (RandomAgent, DistilledCoopAStarAgent), (DistilledCoopAStarAgent, GreedyProbabilisticWaitingAgent), (GreedyProbabilisticAgent, GreedyWaitingAgent), (TeammateAwareWaitingAgent, GreedyWaitingAgent), (TeammateAwarePredator, RandomAgent), (TeammateAwareWaitingAgent, RandomAgent), (GreedyProbabilisticWaitingAgent, RandomAgent), (GreedyProbabilisticWaitingAgent, GreedyPredatorAgent), (TeammateAwareWaitingAgent, TeammateAwarePredator), (DistilledCoopAStarAgent, GreedyProbabilisticAgent), (GreedyWaitingAgent, TeammateAwarePredator), (TeammateAwarePredator, GreedyProbabilisticAgent), (TeammateAwarePredator, GreedyPredatorAgent), (GreedyWaitingAgent, GreedyPredatorAgent), (DistilledCoopAStarAgent, RandomAgent), (GreedyProbabilisticWaitingAgent, DistilledCoopAStarAgent), (GreedyWaitingAgent, GreedyProbabilisticAgent), (RandomAgent, RandomAgent), (RandomAgent, RandomAgent), (GreedyPredatorAgent, GreedyPredatorAgent), (GreedyPredatorAgent, GreedyPredatorAgent), (GreedyProbabilisticWaitingAgent, GreedyProbabilisticWaitingAgent), (GreedyProbabilisticWaitingAgent, GreedyProbabilisticWaitingAgent), (TeammateAwareWaitingAgent, TeammateAwareWaitingAgent), (TeammateAwareWaitingAgent, TeammateAwareWaitingAgent)]
