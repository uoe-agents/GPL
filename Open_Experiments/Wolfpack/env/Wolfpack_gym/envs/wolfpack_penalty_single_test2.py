...
from Wolfpack_gym.envs.wolfpack_penalty_single_assets.Agents import *
...
class WolfpackPenaltySingleTest2(gym.Env):
    ...
    def __init__(self, grid_height=20, grid_width=20, num_players=5, max_food_num=2,
                 ...
                 prey_with_gpu=False, with_oppo_mod=True, close_penalty=0.5):
    ...
    def sample_teammates(self, num_sampled):
        poss_teammates = [(GreedyPredatorAgent, DistilledCoopAStarAgent), (GreedyPredatorAgent, GreedyProbabilisticAgent), (DistilledCoopAStarAgent, GreedyWaitingAgent), (GreedyPredatorAgent, TeammateAwareWaitingAgent), (RandomAgent, GreedyProbabilisticAgent), (TeammateAwarePredator, GreedyProbabilisticWaitingAgent), (GreedyProbabilisticWaitingAgent, TeammateAwareWaitingAgent), (RandomAgent, GreedyWaitingAgent), (TeammateAwarePredator, DistilledCoopAStarAgent), (GreedyProbabilisticAgent, TeammateAwareWaitingAgent), (GreedyProbabilisticAgent, GreedyProbabilisticWaitingAgent), (GreedyWaitingAgent, GreedyProbabilisticWaitingAgent), (DistilledCoopAStarAgent, TeammateAwareWaitingAgent), (RandomAgent, GreedyPredatorAgent), (DistilledCoopAStarAgent, GreedyPredatorAgent), (GreedyProbabilisticAgent, GreedyPredatorAgent), (GreedyWaitingAgent, DistilledCoopAStarAgent), (TeammateAwareWaitingAgent, GreedyPredatorAgent), (GreedyProbabilisticAgent, RandomAgent), (GreedyProbabilisticWaitingAgent, TeammateAwarePredator), (TeammateAwareWaitingAgent, GreedyProbabilisticWaitingAgent), (GreedyWaitingAgent, RandomAgent), (DistilledCoopAStarAgent, TeammateAwarePredator), (TeammateAwareWaitingAgent, GreedyProbabilisticAgent), (GreedyProbabilisticWaitingAgent, GreedyProbabilisticAgent), (GreedyProbabilisticWaitingAgent, GreedyWaitingAgent), (TeammateAwareWaitingAgent, DistilledCoopAStarAgent), (GreedyPredatorAgent, RandomAgent), (GreedyProbabilisticAgent, GreedyProbabilisticAgent), (GreedyProbabilisticAgent, GreedyProbabilisticAgent), (TeammateAwarePredator, TeammateAwarePredator), (TeammateAwarePredator, TeammateAwarePredator), (DistilledCoopAStarAgent, DistilledCoopAStarAgent), (DistilledCoopAStarAgent, DistilledCoopAStarAgent), (GreedyWaitingAgent, GreedyWaitingAgent), (GreedyWaitingAgent, GreedyWaitingAgent)]
        chosen_pair = poss_teammates[np.random.choice(range(len(poss_teammates)), 1)[0]]
       	return [chosen_pair[0](1), chosen_pair[1](2)]
